   ...
   // isCreatAcount: Boolean = false,
    ...
    Column(verticalArrangement = Arrangement.Top) {
        Card(
            ...
            MovieRow(navController = navController, movie = newMovieList.first())
        ...
        Row {
            Text(
                text = newMovieList[0].name, fontWeight = FontWeight.Bold,
        ...
        Text(
            text = newMovieList[0].id, fontWeight = FontWeight.Bold,
            modifier = Modifier.padding(start = 5.dp),
            //color = Color.Black
        )
        Spacer(modifier = Modifier.height(5.dp))
        Text(
            text = newMovieList[0].price, fontWeight = FontWeight.Bold,
            modifier = Modifier.padding(start = 5.dp),
            //color = Color.Black
        )
        ...
        Row {
            ...
            Text(
                text = newMovieList[0].color, fontWeight = FontWeight.Bold,
                modifier = Modifier.padding(start = 5.dp),
                fontSize = 22.sp,
                //color = Color.Black
            )
