package com.example.lastgradutionproject.screans.ClientScreans.orderscrean3
...
fun nextorder(
    ...
    Surface (color= Color.White){
        ...
        val newMovieList3 = getmovies3().filter { movie3 ->
            movie3.id == movieId
        ...
        Column(verticalArrangement = Arrangement.Top) {
            Card(
                ...
                MovieRow3(navController = navController, movie3 = newMovieList3.first())
            ...
            Row {
                Text(
                    text = newMovieList3[0].name, fontWeight = FontWeight.Bold,
            ...
            Text(
                text = newMovieList3[0].id, fontWeight = FontWeight.Bold,
                modifier = Modifier.padding(start = 5.dp),
                //color = Color.Black
            )
            Spacer(modifier = Modifier.height(5.dp))
            Text(
                text = newMovieList3[0].price, fontWeight = FontWeight.Bold,
                modifier = Modifier.padding(start = 5.dp),
                //color = Color.Black
            )
            ...
            Row {
                ...
                Text(
                    text = newMovieList3[0].color, fontWeight = FontWeight.Bold,
                    modifier = Modifier.padding(start = 5.dp),
                    fontSize = 22.sp,
                    //color = Color.Black
                )
