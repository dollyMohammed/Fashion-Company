package com.example.lastgradutionproject.screans.ClientScreans.Login
...
import com.example.lastgradutionproject.screans.startScrean.SelectButton
import com.example.lastgradutionproject.screans.startScrean.nameFailed

@Composable
fun LoginScrean(navController: NavController,
    ...
    Surface (color = Color.White) {
        /*/Row (modifier = Modifier.padding(top = 129.dp, start = 70.dp)){
        ...
        signup(
            ...
            //onDone(Email.value.trim(), password.value.trim())
            navController.navigate(MillanoScreans.SignUpScrean.name)
    ...
    Column(
        ...
        modifier = Modifier.padding(top = 150.dp, bottom = 20.dp)
    ) {
        Email(
        ...
        Text(
            modifier = Modifier
                ...
                .clickable {
                    navController.navigate(MillanoScreans.forgetpasswoed.name)
                },
            text = "Forget password", fontSize = 19.sp, fontWeight = FontWeight.SemiBold,
            color = Color.Black
        )
        ...
        Button(onClick = {
            onDone(Email.value.trim(), password.value.trim())
            va.login(Email.value,password.value)
            ...
            Text(text = "Login", color = Color.White, fontWeight = FontWeight.SemiBold, fontSize = 19.sp)
       ...
       /* LoginButton(
        ...
        Row(horizontalArrangement = Arrangement.Center) {
            ...
            Text(
                ...
                text = "SignUp", fontSize = 19.sp, fontWeight = FontWeight.SemiBold,
...
fun signup(loading: Boolean,
    ...
    Button(          onClick=onClick,
       ...
       // enabled = !loading && validInputs,
        ...
        Text(text = "Sign Up", color = Color.Black, fontWeight = FontWeight.SemiBold, fontSize = 19.sp)
        //if (loading) CircularProgressIndicator(modifier = Modifier.size(25.dp))
    }
...
fun passwordFailed(
    ...
    OutlinedTextField(
        ...
        trailingIcon = {PasswordVisability(passwordVisibility=passwordVisibility)}
        //
        //BorderStroke(width = 5.dp, color = Color.Black)
    )
