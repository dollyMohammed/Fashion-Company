...
sealed class DistinationScrean(val route:String){
    object Main:DistinationScrean("main")
    object SignUp:DistinationScrean("SignUp")
    object Login:DistinationScrean("Login")
    object Success:DistinationScrean("Success")
}
